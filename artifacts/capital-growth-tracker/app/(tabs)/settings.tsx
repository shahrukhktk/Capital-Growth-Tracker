...
const styles = StyleSheet.create({
  ...
  introCard: { borderRadius: 18, padding: 18, gap: 7 },
  introTitle: { color: '#FFFFFF', fontSize: 19, fontWeight: '700' },
  introCopy: { color: '#C3B29A', fontSize: 12, lineHeight: 18 },
  sectionLabel: { fontSize: 10, letterSpacing: 1.4, fontWeight: '700', marginTop: 7 },
  formCard: { borderRadius: 16, borderWidth: 1, paddingHorizontal: 14, paddingVertical: 3 },
  field: { paddingVertical: 13, gap: 4 },
  fieldLabel: { fontSize: 13, fontWeight: '700' },
  fieldHint: { fontSize: 11, lineHeight: 16 },
  inputWrap: { marginTop: 6, borderRadius: 10, borderWidth: 1, height: 44, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 11 },
  prefix: { fontSize: 13, fontWeight: '700' },
  input: { flex: 1, fontSize: 16, fontWeight: '700', paddingVertical: 0, marginHorizontal: 8 },
  divider: { height: 1, backgroundColor: '#E8E0D6' },
  weekRow: { flexDirection: 'row', gap: 4, marginVertical: 13 },
  dayButton: { flex: 1, height: 52, borderRadius: 10, borderWidth: 1, alignItems: 'center', justifyContent: 'center', gap: 5 },
  ...
  reconcileCard: { borderRadius: 14, padding: 12, flexDirection: 'row', gap: 10, alignItems: 'center' },
