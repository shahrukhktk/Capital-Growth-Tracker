...
const styles = StyleSheet.create({
  ...
  summaryCard: { borderWidth: 1, borderRadius: 21, padding: 17, gap: 13 },
  summaryTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  monthTitle: { fontSize: 19, fontWeight: '700' },
  ...
  bigNumber: { fontSize: 29, fontWeight: '700', letterSpacing: -1 },
  ...
  metricCard: { width: '31.8%', minHeight: 76, borderRadius: 15, borderWidth: 1, padding: 10, justifyContent: 'space-between' },
  ...
  recordsCard: { borderWidth: 1, borderRadius: 19, paddingHorizontal: 13 },
